...
campus_active = "0x8bb1"
    

def extract_data(filename):
    with fitz.open(filename) as pdfdata:
        # temporarily ignoring the metadata check until i find a better solution, too many people have weird browsers/extensions/pdf readers that modify the metadata
    ...
    for table in table_list:
        ...
        for lis in table['data']:
            if i > 0:
                ...
                filtered_instructor = re.sub('\r', ' ', lis[7]['text'])
                ...
                current_class_and_section['instructor'] = filtered_instructor
